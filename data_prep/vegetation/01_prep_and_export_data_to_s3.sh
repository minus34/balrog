...
/Applications/Postgres.app/Contents/Versions/13/bin/pg_dump -Fc -d geo -t bushfire.nvis6_lookup -t bushfire.nvis6_exploded -t bushfire.nvis6_bal -p 5432 -U postgres -f "${OUTPUT_FOLDER}/nvis6.dmp" --no-owner
